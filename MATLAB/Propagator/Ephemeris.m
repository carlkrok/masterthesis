...
[ t, Y ] = ode45( @(t, Y) SatelliteAcceleration(t, Y, missionData.mu, missionData.pointingTarget_ECEF, satData.M_mat, satData.I_mat, rwData.rotMat, rwData.I_mat, rwData.maxTorque, rwData.maxMomentum ), stepTimes, Y0, opts );
