...
sat.propulsion.thrusters(2).thrustRange = (0:20) .* 10^-6;
...
sat.propulsion.thrusters(3).thrustRange = (0:20) .* 10^-6;
...
sat.propulsion.thrusters(4).thrustRange = (0:20) .* 10^-6;
...
sat.propulsion.thrusters(5).thrustRange = (0:20) .* 10^-6;
...
sat.propulsion.thrusters(6).thrustRange = (0:20) .* 10^-6;
