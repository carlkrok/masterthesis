...
sat.propulsion.thrusters(2).thrustRange = [0; 0.1; 0.25; 0.5; 0.75; 1; ... 
    1.25; 1.5; 1.75; 2] .* 10^-3;
...
sat.propulsion.thrusters(3).thrustRange = [0; 0.1; 0.25; 0.5; 0.75; 1; ... 
    1.25; 1.5; 1.75; 2] .* 10^-3;
...
sat.propulsion.thrusters(4).thrustRange = [0; 0.1; 0.25; 0.5; 0.75; 1; ... 
    1.25; 1.5; 1.75; 2] .* 10^-3;
...
sat.propulsion.thrusters(5).thrustRange = [0; 0.1; 0.25; 0.5; 0.75; 1; ... 
    1.25; 1.5; 1.75; 2] .* 10^-3;
...
sat.propulsion.thrusters(6).thrustRange = [0; 0.1; 0.25; 0.5; 0.75; 1; ... 
    1.25; 1.5; 1.75; 2] .* 10^-3;
...
sat.propulsion.thrusters(7).thrustRange = [0; 0.1; 0.25; 0.5; 0.75; 1; ... 
    1.25; 1.5; 1.75; 2] .* 10^-3;
...
sat.propulsion.thrusters(8).thrustRange = [0; 0.1; 0.25; 0.5; 0.75; 1; ... 
    1.25; 1.5; 1.75; 2] .* 10^-3;
...
sat.propulsion.thrusters(9).thrustRange = [0; 0.1; 0.25; 0.5; 0.75; 1; ... 
    1.25; 1.5; 1.75; 2] .* 10^-3;
...
sat.propulsion.thrusters(10).thrustRange = [0; 0.1; 0.25; 0.5; 0.75; 1; ... 
    1.25; 1.5; 1.75; 2] .* 10^-3;
...
sat.propulsion.thrusters(11).thrustRange = [0; 0.1; 0.25; 0.5; 0.75; 1; ... 
    1.25; 1.5; 1.75; 2] .* 10^-3;
...
sat.propulsion.thrusters(12).thrustRange = [0; 0.1; 0.25; 0.5; 0.75; 1; ... 
    1.25; 1.5; 1.75; 2] .* 10^-3;
