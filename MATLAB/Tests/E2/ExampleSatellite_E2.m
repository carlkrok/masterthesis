...
omegaRef = [simConfig.firstReferenceOmega * ones(1,(simConfig.secondReferenceOmegaTime/timestep_pd)+1), ...
    simConfig.secondReferenceOmega * ones(1,(simConfig.thirdReferenceOmegaTime-simConfig.secondReferenceOmegaTime+1)/timestep_pd), ...
    simConfig.thirdReferenceOmega * ones(1,(duration-simConfig.thirdReferenceOmegaTime+1)/timestep_pd)];
