...
omegaRefTime = [0:timestep_pd:simConfig.secondReferenceOmegaTime, ...
    simConfig.secondReferenceOmegaTime:timestep_pd:simConfig.thirdReferenceOmegaTime, ...
    simConfig.thirdReferenceOmegaTime:timestep_pd:duration];
...
omegaRef = [simConfig.firstReferenceOmega * ones(1,(simConfig.secondReferenceOmegaTime/timestep_pd)+1), ...
    simConfig.secondReferenceOmega * ones(1,(simConfig.thirdReferenceOmegaTime-simConfig.secondReferenceOmegaTime)/timestep_pd+1), ...
    simConfig.thirdReferenceOmega * ones(1,(duration-simConfig.thirdReferenceOmegaTime)/timestep_pd+1)];
