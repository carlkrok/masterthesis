...
eph = SimulateSatellite_integerMPC( t0_MJD, satelliteFilename, timestep_mpc, ...
    timestep_mpc, duration, prediction_horizon, numControlVariables, ...
...
quatRef = [simConfig.firstReferenceQuaternion * ones(1,round((simConfig.secondReferenceQuaternionTime+1)/timestep_mpc)), ...
    simConfig.secondReferenceQuaternion * ones(1,round((simConfig.thirdReferenceQuaternionTime-simConfig.secondReferenceQuaternionTime)/timestep_mpc)), ...
    simConfig.thirdReferenceQuaternion * ones(1,round((duration-simConfig.thirdReferenceQuaternionTime)/timestep_mpc))];
